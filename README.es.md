...
- **Complemento para Home Assistant**: este repositorio funciona además como
...
instance](https://my.home-assistant.io/badges/supervisor_add_addon_repository.svg)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%2Fananthb%2Fstarla)
...
después instala el complemento **Starla**. Consulta la [documentación del
complemento](starla/DOCS.md).
